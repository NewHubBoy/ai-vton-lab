...
import { Bars3Icon, XMarkIcon, Sparkles, ArrowRight, Check, Zap, Layers, Image as ImageIcon, Shield } from 'lucide-react'
          ...
          <div className="relative mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
            <div style={fadeInUp('section-hero', 0)} className="mx-auto max-w-3xl text-center">
              ...
              <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
                <a
                  href="/try-on"
                  className="inline-flex items-center gap-2 rounded-lg bg-zinc-900 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-violet-500/25 hover:bg-zinc-800 hover:shadow-violet-500/40 transition-all dark:bg-white dark:text-zinc-900 dark:hover:bg-zinc-100"
                >
                  立即体验
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
              {pricing.map((plan, index) => (
                <div
                  ...
                  className={`relative rounded-2xl p-8 shadow-lg ring-1 transition-all hover:shadow-xl ${
                    plan.popular
            ...
            >
              ...
              <div className="relative mx-auto max-w-2xl text-center">
                ...
                <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
                  <a
                    href="/try-on"
                    className="inline-flex items-center gap-2 rounded-lg bg-white px-6 py-3 text-sm font-semibold text-zinc-900 shadow-lg hover:bg-zinc-100 transition-all"
                  >
                    免费开始
                    <ArrowRight className="w-4 h-4" />
                  </a>
