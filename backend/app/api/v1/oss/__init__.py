...
@oss_router.post("/upload", summary="上传文件到 OSS")
...
@oss_router.post("/upload/multiple", summary="批量上传文件到 OSS")
...
@oss_router.post("/upload/base64", summary="上传 Base64 编码的文件")
...
@oss_router.delete("/delete", summary="删除 OSS 文件")
...
@oss_router.get("/sign-url", summary="生成签名URL")
