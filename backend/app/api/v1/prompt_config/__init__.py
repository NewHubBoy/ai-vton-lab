...
@prompt_config_router.get("/groups", summary="获取配置组列表")
...
@prompt_config_router.post("/groups", summary="创建配置组")
...
@prompt_config_router.put("/groups/{id}", summary="更新配置组")
...
@prompt_config_router.get("/groups/{group_id}/options", summary="获取配置选项列表")
...
@prompt_config_router.post("/options", summary="创建配置选项")
...
@prompt_config_router.put("/options/{id}", summary="更新配置选项")
