...
export default function RegisterPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col justify-center px-6 py-12 sm:px-6 lg:px-8 bg-gray-50 dark:bg-black">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        {/* Logo */}
        <div className="flex justify-center">
          <Link href="/" className="flex h-12 w-12 items-center justify-center rounded-xl bg-linear-to-br from-violet-500 to-fuchsia-500">
        ...
        <div className="bg-white px-6 py-12 shadow-sm sm:rounded-lg sm:px-12 dark:bg-gray-800/50 dark:shadow-none dark:outline dark:-outline-offset-1 dark:outline-white/10">
          ...
          <div>
            <div className="mt-8 flex items-center gap-x-6">
              ...
              <p className="text-sm/6 font-medium text-nowrap text-gray-900 dark:text-white">或使用以下方式</p>
              <div className="w-full flex-1 border-t border-gray-200 dark:border-white/10" />
            </div>
